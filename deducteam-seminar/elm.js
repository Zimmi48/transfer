...
var _Zimmi48$ttt2017$Main$md = A2(
	...
	{ctor: '[]'});
var _Zimmi48$ttt2017$Main$references = {
	ctor: '::',
	_0: A2(
				...
				_rtfeldman$elm_css$Css$asPairs(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$lineHeight(
							_rtfeldman$elm_css$Css$pct(120)),
						_1: {ctor: '[]'}
					})),
			_1: {ctor: '[]'}
		},
...
var _Zimmi48$ttt2017$Main$perspectives = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$flip3 = {
	ctor: '::',
	_0: _Zimmi48$ttt2017$Main$md('\n\n  ## Flip in `impl` mode\n\n    Related impl (B.leq x B.0) ?\n\n  transformed into:\n\n    Related (flip R) x ?\n    Related (flip R) B.0 ?\n    Related (flip R ##> flip R ##> impl) B.leq A.leq\n\n  '),
	_1: {ctor: '[]'}
};
var _Zimmi48$ttt2017$Main$flip2 = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$flip = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$subrel = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$typeclasses = {
	ctor: '::',
					...
					},
					{
									...
									_rtfeldman$elm_css$Css$asPairs(
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$color(
												A3(_rtfeldman$elm_css$Css$rgb, 0, 255, 0)),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Very concise programming, very readable.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Hard to debug puzzling behaviors.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Critical reliance on Coq\'s unification.'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _Zimmi48$ttt2017$Main$difficultyRaggi = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$applicationRaggi = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$difficultyMagaud = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$applicationMagaud = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$example2 = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$example = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$introElimRules = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$implementationLogic = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$respectfulTotal = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$respectfulFunctional = {
	ctor: '::',
	_0: _Zimmi48$ttt2017$Main$md('\n\n  ## Unfolding respectful\n\n  Right-uniqueness = functionality:\n\n    Related (R ##> R ##> impl) eq my_eq\n      = ∀ (x1 : A) (y1 : B), R x1 y1 →\n        ∀ (x2 : A) (y2 : B), R x2 y2 →\n        x1 = x2 → my_eq y1 y2\n\n  Left-uniqueness = injectivity.\n  Bi-uniqueness = both.\n\n  '),
	_1: {ctor: '[]'}
};
var _Zimmi48$ttt2017$Main$transferUserWeak = {
	ctor: '::',
	_0: _Zimmi48$ttt2017$Main$md('\n\n  ## Transfer library\n\n  ### User perspective\n\n  Or some weaker relation:\n\n    Instance rightunique :\n      Related (R ##> R ##> impl) eq my_eq.\n    Instance righttotal :\n      Related ((R ##> impl) ##> impl) all ball.\n\n  '),
	_1: {ctor: '[]'}
};
var _Zimmi48$ttt2017$Main$transferUser = {
	ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Allow to merge independent developments '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('(see applications later)'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Explicit transfer sometimes useful in math '),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _Zimmi48$ttt2017$Main$axiomatization = {
	ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Some behaviors can be left unspecified.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('No proof by computation is possible.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Rewriting with an equivalence (vs equality).'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _Zimmi48$ttt2017$Main$representationIssue = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$outline = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$transferIntro = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$introduction = {
	ctor: '::',
	...
	A2(
		...
		_xarvh$elm_slides$Slides$htmlFragments,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _Zimmi48$ttt2017$Main$transferIntro,
					_1: {
						ctor: '::',
						_0: _Zimmi48$ttt2017$Main$outline,
						_1: {
							ctor: '::',
							_0: _Zimmi48$ttt2017$Main$representationIssue,
							_1: {
								ctor: '::',
								_0: _Zimmi48$ttt2017$Main$axiomatization,
								_1: {
									ctor: '::',
									_0: _Zimmi48$ttt2017$Main$transferApproach,
									_1: {
										ctor: '::',
										_0: _Zimmi48$ttt2017$Main$definitions,
										_1: {
											ctor: '::',
											_0: _Zimmi48$ttt2017$Main$transferUser,
											_1: {
												ctor: '::',
												_0: _Zimmi48$ttt2017$Main$transferUserWeak,
												_1: {
													ctor: '::',
													_0: _Zimmi48$ttt2017$Main$respectfulFunctional,
													_1: {
														ctor: '::',
														_0: _Zimmi48$ttt2017$Main$respectfulTotal,
														_1: {
															ctor: '::',
															_0: _Zimmi48$ttt2017$Main$transferMorphism,
															_1: {
																ctor: '::',
																_0: _Zimmi48$ttt2017$Main$transferTactic,
																_1: {
																	ctor: '::',
																	_0: _Zimmi48$ttt2017$Main$transferTactic2,
																	_1: {
																		ctor: '::',
																		_0: _Zimmi48$ttt2017$Main$exactTactic,
																		_1: {
																			ctor: '::',
																			_0: _Zimmi48$ttt2017$Main$implementationLogic,
																			_1: {
																				ctor: '::',
																				_0: _Zimmi48$ttt2017$Main$introElimRules,
																				_1: {
																					ctor: '::',
																					_0: _Zimmi48$ttt2017$Main$structuralRules,
																					_1: {
																						ctor: '::',
																						_0: _Zimmi48$ttt2017$Main$myRules,
																						_1: {
																							ctor: '::',
																							_0: _Zimmi48$ttt2017$Main$rewritingRules,
																							_1: {
																								ctor: '::',
																								_0: _Zimmi48$ttt2017$Main$example,
																								_1: {
																									ctor: '::',
																									_0: _Zimmi48$ttt2017$Main$example2,
																									_1: {
																										ctor: '::',
																										_0: _Zimmi48$ttt2017$Main$example3,
																										_1: {
																											ctor: '::',
																											_0: _Zimmi48$ttt2017$Main$implementation,
																											_1: {
																												ctor: '::',
																												_0: _Zimmi48$ttt2017$Main$applicationMagaud,
																												_1: {
																													ctor: '::',
																													_0: _Zimmi48$ttt2017$Main$difficultyMagaud,
																													_1: {
																														ctor: '::',
																														_0: _Zimmi48$ttt2017$Main$applicationRaggi,
																														_1: {
																															ctor: '::',
																															_0: _Zimmi48$ttt2017$Main$difficultyRaggi,
																															_1: {
																																ctor: '::',
																																_0: _Zimmi48$ttt2017$Main$typeclasses,
																																_1: {
																																	ctor: '::',
																																	_0: _Zimmi48$ttt2017$Main$subrel,
																																	_1: {
																																		ctor: '::',
																																		_0: _Zimmi48$ttt2017$Main$flip,
																																		_1: {
																																			ctor: '::',
																																			_0: _Zimmi48$ttt2017$Main$flip2,
																																			_1: {
																																				ctor: '::',
																																				_0: _Zimmi48$ttt2017$Main$flip3,
																																				_1: {
																																					ctor: '::',
																																					_0: _Zimmi48$ttt2017$Main$perspectives,
																																					_1: {
																																						ctor: '::',
																																						_0: _Zimmi48$ttt2017$Main$references,
																																						_1: {ctor: '[]'}
																																					}
																																				}
																																			}
